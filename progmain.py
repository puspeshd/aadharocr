...
def mainfunc():
    ...
    def aadharcardb(strdf):
        ...
        try:
            ...
            addfinal = {"Flag": '' ,"House_no": '', "Building_name": '', "locality": '', "street": '', "city": '', "state": '', "country": '', "PIN": '', "LATITUDE": '', "LONGITUDE": ''}
            return(addfinal)
    def aadharfull(strdf):
        ...
        try:
            ...
            addfinal = {"Name": '', "DOB": '',"GENDER": '', "AADHAR NO": '',"Flag": '' ,"House no": '', "Building_name": '', "locality": '', "street": '', "city": '', "state": '', "country": '', "PIN": '', "LATITUDE": '', "LONGITUDE": ''}
            return (addfinal)
    ...
    try:
     x=cv2.imread(image_path.filename)
