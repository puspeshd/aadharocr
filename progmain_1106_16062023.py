...
def photoupd():
  ...
  try:
    ...
    if (request.method == "POST"):
        ...
        #logfile.write("\n"+"FILE RECEIVED TO API FROM FORM ")
        ...
        cv2.imwrite(name,img)
        #logfile.write("\n"+name+" IMAGE OR PDF SAVED TO THE JPG FORMAT ")
        return (image_path)
    
  except:
      errcode={"error_code":3,"error_message":"Could not read. Please Proceed with manual mode or upload again 11"}
      #logfile.write("\n"+str(errcode)+"FAILED TO CONVERT IMAGE TO CORRECT IMAGE FORMAT ")
      #logfile.close()
      return(errcode) 
...
def mainfunc():
   ...
   try:
    ...
    return {"error_message":"ERRRRRRRRRRRORRRRRRRRRRRR"}
   finally:
       print("ALL IS WELL") 
